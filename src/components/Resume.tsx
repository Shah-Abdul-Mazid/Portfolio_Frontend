    ...
    return (
        <div className="rv-page">
            ...
            <style>{`
                ...
                .rv-sheet { width: min(794px, 100%) !important; background: white !important; color: #1a1a1a !important; font-size: 13.5px !important; line-height: 1.4 !important; padding: 1in !important; box-shadow: 0 4px 24px rgba(0,0,0,0.1) !important; text-align: left !important; box-sizing: border-box !important; }
                ...
                @media print { 
                    ...
                    .rv-sheet { box-shadow: none; width: 100%; padding: 1in !important; margin: 0; box-sizing: border-box !important; }
